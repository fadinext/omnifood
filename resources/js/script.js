...
$(document).ready( function() {
    ...
    /*scroll on buttons*/
    $('.js--scroll-to-plans').click( _ => $('html,body').animate({scrollTop: $('.js--section-plans').offset().top}, 1000))

    $('.js--scroll-to-start').click( _ => $('html,body').animate({scrollTop: $('.js--section-features').offset().top}, 1000))

    /*smooth scrolling and anchors*/
    smoothScrolling()

    /*animation on scroll*/
    $('.js--wp-1').waypoint( direction => $('.js--wp-1').addClass('animate__animated animate__fadeIn'), {offset:'50%'} )
